...
WebUI.callTestCase(findTestCase('Metodos/Login/Inicio sesion'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Metodos/mi cuenta/ir a mi cuenta'), [:], FailureHandling.STOP_ON_FAILURE)
